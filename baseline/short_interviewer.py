"""
LLMREI-Short baseline interviewer for requirement elicitation.
加载 prompt 从 baseline/prompt/short/ 下的 txt 文件，复用 ReqElicitGym 的 model_call 与 build_history_into_prompt。
"""

from pathlib import Path
from typing import Any, Dict, List

_PROMPT_DIR = Path(__file__).resolve().parent / "prompt" / "short"
...
class Interviewer:
    """LLMREI-Short 风格 Interviewer，使用短系统 prompt。"""
    ...
    def __repr__(self) -> str:
        return f"Interviewer(model={self.model_name}, style=LLMREI-Short)"
